...
expName = 'multicolor_grating_demo'  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\akoun\\Desktop\\Biocruces\\siburmuin\\src\\multicolor_grating_demo\\multicolor_grating_demo_lastrun.py',
...
def setupWindow(expInfo=None, win=None):
    ...
    if win is None:
        ...
        win = visual.Window(
            ...
            monitor='testMonitor', color=[-1.0000, -0.0745, 0.0000], colorSpace='rgb',
        ...
        win.color = [-1.0000, -0.0745, 0.0000]
        win.colorSpace = 'rgb'
        win.backgroundImage = ''
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    logs = visual.TextStim(win=win, name='logs',
        text=None,
        font='Open Sans',
        pos=(0.6, 0.35), height=0.025, wrapWidth=None, ori=0.0, 
    ...
    for thisTrial in trials:
        ...
        image.setImage('./images/custom_stim.png')
        key_resp.keys = []
        key_resp.rt = []
        _key_resp_allKeys = []
        # keep track of which components have finished
        trialComponents = [image, key_resp, logs]
